  ...
  Widget build(BuildContext context) {
    ...
    if (selectedContact == null) {
      return CustomDropDown(
        ...
        items: const [
          '561 - Visita Familiar',
          '570 - Cuban Resident Ret',
          '545 - Export/Import',
          '559 - Export TransacTions',
          '566 - Religious',
          '567 - Performance/Workshop',
          '574 - Support for the Cub',
          '575 - Humanitarian Projects',
          '576 - Private Fundations',
          '578 - Export of internet',
          '562 - Official Diplomatic',
          '563 - Journalist',
          '564 - Professional Research',
          '565 - Educational',
        ],
        hintext: ofacCode,
        onChanged: (value) =>
